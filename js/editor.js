/*
*  Created on 5/11/15 by brandon bronisz & Sam Belcastro
*
*  ##### What's new #######
*  - cursor
*    - blinkCursor() method
*
*  - changed from jquery back to js...
*  - Added self executing function to only run the script when the page is ready	
*
*
*  ##### TODO #######
*  - cursor selection
*  - remove cursor when the editor is not selected
*  - fix design of editor
*  - ADD MATHJAX
*/
